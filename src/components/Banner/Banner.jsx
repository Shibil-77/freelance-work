...
import BannerImg from "../../assets/images-src/Banner.jpg";
import BannerImg2 from "../../assets/images-src/Concrete-2.JPG";
        ...
        <div className="lg:flex my-5 ">
          <div className="lg:w-6/12 w-full ">
            <div className="flex  lg:mx-0 mx-5">
              <img src={BannerImg} className="rounded-3xl h-96 w-full border border-[#00000065]" alt="" />
            </div>
          ...
          <div className="lg:w-6/12 w-full">
            <div className="flex  lg:mx-0 mx-5">
              <img
                src='https://res.cloudinary.com/dbb0ncoht/image/upload/v1707907338/Freelance%28Never%20dlt%29/DSC06477_izuef2.jpg'
                className="rounded-3xl h-96 w-full border border-[#00000065]"
                alt=""
              />
            ...
            <div className=" w-full h-auto flex justify-center py-5">
              ...
              Transforming blueprints into breathtaking structures with precision and passion.
              </h1>
            </div>
          </div>
        </div>
