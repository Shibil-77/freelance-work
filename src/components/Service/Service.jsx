...
import testImg from "../../assets/img/IMG-20240210-WA0004.jpg";
  ...
  return (
    <div className="container">
      ...
      <div className="flex justify-center">
        <button
          type="button"
          class="text-white px-9 bg-black hover:bg-black focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
        >
         SEE ALL
        </button>
      </div>
